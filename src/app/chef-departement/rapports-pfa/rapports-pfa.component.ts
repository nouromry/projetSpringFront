...
@Component({
  selector: 'app-rapports-pfa',
  templateUrl: './rapports-pfa.component.html',
  styleUrls: ['./rapports-pfa.component.css']
})
export class RapportsPfaComponent implements OnInit {
  documents: Document[] = [];
  ...
  loadDocuments(): void {
    this.documentService.getAllDocuments().subscribe(
      (data) => {
        this.documents = data.filter(doc => doc.type === 'rapport_final');
        this.applyFilter();
      },
      (error) => {
